...
public class WebProxy {
    ...
    private static int analytic_instructions;

    public static void main(String[] args) {
        WebProxy.port = 8090;
        WebProxy.analytic_instructions = 8091;
        ProxyServer p_server = new ProxyServer(WebProxy.port, WebProxy.analytic_instructions  );
        p_server.start();
    }
}
...
class ProxyServer {
    ...
    private int analytic_ins;

    public HashMap <String, String> cache;

    public ProxyServer(int port, int analytic_ins) {
        this.listeningPort = port;
        this.analytic_ins = analytic_ins;
    }
...
// this part handles each http request
